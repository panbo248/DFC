...
if [ "$lang_choice" = "1" ]; then
    ...
    m_7="Default account is panbo default password is 19900818"
    ...
    m_9="Password reset completed, changed to default account password panbo 19900818"
    ...
    m_5="程序已经启动，请不要重复启动。"
    m_6="程序启动成功, WEB访问端口"
    m_7="默认账号 panbo 默认密码 19900818"
    m_8="如果您是默认密码及默认端口, 请及时在网页设置中修改账号密码及web访问端口。"
    m_9="重置密码完成, 已修改为默认账号密码 panbo 19900818"
    m_10="终止进程..."
    m_11="未发现"
    m_12="进程"
    m_13="终止"
